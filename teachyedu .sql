...
--
-- Host: localhost:3306
-- Tempo de geração: 12-Mar-2022 às 22:13
...
CREATE TABLE `assinantes` (
  ...
  `interesseAssinante` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
(1, 'João Pedro', 'joaopedrodmg@gmail.com', '7751a23fa55170a57e90374df13a3ab78efe0e99', 0, 'X7IOLAOX74A4F74G', 0, '2022-03-12 00:24:09');
...
--
ALTER TABLE `assinantes`
  MODIFY `idAssinante` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `modulos`
  MODIFY `idModulo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
