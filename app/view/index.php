...
<body>
    ...
    <div class="py-5 text-left text-white align-items-center d-flex cabecalho" style="background-image: url(../../public/images/bg.png);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat; background-attachment: fixed;">
    ...
    <div class="containerEdit" style="background-image: url(../../public/images/bgindex.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat; background-attachment: fixed;">
        <div class="container">
            <div class="row">
