...
if (isset($_GET['idCurso'])) {
    ...
    $curso = array();
    $id = $_GET['idCurso'];
    $curso = $dao->consultarCursoCompleto($id);
    $modulos = array();
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/KCk4O6EBXHw" allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    ...
                    <?php foreach ($modulos as $modulo): ?>
                        <div class="card">
                            <div class="card-header" id="heading">
                                <h5 class="mb-0">
                                    <button class="btn btn-link" data-toggle="collapse" data-target="#collapse<?php echo $modulo['idModulo'] ?>"
                                            aria-expanded="true"
